...
router.post("/", authenticateToken, requireRole("admin"), NewsController.createNews);
// PUT /api/news/:id - Update news by ID (Admin only)
router.put("/:id", authenticateToken, requireRole("admin"), NewsController.updateNews);
...
router.post("/:newsId/images", authenticateToken, requireRole("admin"), uploadNewsImages.array("images", 5), // Allow up to 5 images
...
router.delete("/images/:imageId", authenticateToken, requireRole("admin"), NewsController.deleteNewsImage);
